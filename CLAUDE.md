...
- **⚠ WHY THE CLIENT SEES THE MINOR STUFF.** 55% of matched reads roster-wide are withheld, and they are not a random 55% — every one is a named DIAGNOSIS (BP, T2D, thyroid, PCOS, autoimmune), because the book marks those sensitive/coach-only, correctly. What survives is symptom-level. The section therefore states the count ("2 more are better talked through together") rather than implying completeness. Do not "fix" this by loosening the gate.
