...
const PATHS: Record<string, IconPart[]> = {
  ...
  flask: [P("M10 4h4"), P("M11 4.5v4.2l-4.4 7.6A1.4 1.4 0 0 0 7.8 18.5h8.4a1.4 1.4 0 0 0 1.2-2.2L13 8.7V4.5"), P("M8.7 14h6.6")],
  ...
  camera: [
    P("M4 8.5h3.2l1.4-2h6.8l1.4 2H20a1 1 0 0 1 1 1v8a1 1 0 0 1-1 1H4a1 1 0 0 1-1-1v-8a1 1 0 0 1 1-1z"),
    P("M12 16.2a3.2 3.2 0 1 0 0-6.4 3.2 3.2 0 0 0 0 6.4z"),
  ],
  bell: [
