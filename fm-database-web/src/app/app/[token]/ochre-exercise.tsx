...
export function ExerciseOverlay({
  ...
  return (
    <div className="ex-wrap">
      ...
      {/* Traced two-pose figure, read BEFORE the movement like the rest of the
          card — it cross-fades start and end so the client sees the shape of
          the rep, not a tempo to follow. Absent for exercises without reviewed
          artwork; the text instructions are always the contract. */}
      {item.figureSvg && (
        <div
          className="ex-figure"
          aria-hidden
