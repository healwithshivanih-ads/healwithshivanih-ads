...
// Goal-based marker defaults moved to ./marker-defaults (pure utility
// module) so the server wrapper can import the function. Re-exported
// below for backwards-compat with any existing callers.
...
// ─── Helpers ────────────────────────────────────────────────────────────────
// pickDefaultMarkers used to live here; moved to ./marker-defaults so the
// server wrapper can import it. Re-exported here for any legacy callers.
export { pickDefaultMarkers } from "./marker-defaults";
