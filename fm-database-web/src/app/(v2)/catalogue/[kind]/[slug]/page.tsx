  ...
  return (
    <div className="space-y-6">
      ...
      <div className="flex gap-4 items-start">
        {/* Diagram, not a photo or a generated human — see exercise-figure.ts.
            Computed from position + joint_stress + balance_demand, so it can
            never disagree with the fields beside it. */}
        <div
          className="w-20 shrink-0 text-muted-foreground"
          // Generated by our own deterministic builder from catalogue enums;
          // the only interpolated free text is escaped in escapeAttr().
