...
7b. AVOID PORRIDGE-STYLE BREAKFASTS (ragi porridge, oats porridge, dalia, upma-as-porridge) by default — most Indian clients find them unappealing and they get skipped. Prefer moong dal chilla, besan cheela, poha, idli/dosa, vegetable paratha, sprouts, egg preparations (if the client eats eggs), or a savoury option instead. Only use a porridge-style breakfast if the client has explicitly asked for it or it's already a dish they like from their current menu/feedback.
