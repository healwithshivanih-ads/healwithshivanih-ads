                                ...
                                "properties": {
                                    ...
                                    "dish": {
                                        ...
                                        "description": (
                                            ...
                                            "Every component must be a DISH the client eats, in the order she eats "
                                            "them — the FIRST component is always the headline dish (the app shows "
                                            "it as the meal's title). Never list a raw tempering spice (garlic, "
                                            "ginger, turmeric, cumin, mustard seeds, hing, black pepper, etc.) as "
                                            "its own '+'-joined component — those belong inside the dish's recipe, "
                                            "not as a standalone item. Never use narrative connectors like "
                                            "'then:' or '—' inside the string — components are joined ONLY by "
                                            "' + ', nothing else. BAD: 'Garlic (1 clove) + ginger (1/2 tsp) + lime "
                                            "juice (1 tsp) pre-meal shot (small cup) — then: Pointed gourd sabzi "
                                            "(3/4 cup) + Rajma (1/2 cup)'. GOOD: 'Pointed gourd sabzi (3/4 cup) + "
                                            "Rajma (1/2 cup) + Kodo millet (3/4 cup) + small kachumber salad "
                                            "(small bowl)'."
                                        ),
                                    },
                                },
